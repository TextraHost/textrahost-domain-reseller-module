...
use ModulesGarden\DomainsReseller\Registrar\TextraHostDomainReseller\Calls;
use ModulesGarden\DomainsReseller\Registrar\TextraHostDomainReseller\Core\Configuration;
use ModulesGarden\DomainsReseller\Registrar\TextraHostDomainReseller\Helpers\ResultsListFactory;

//Loader
include_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'Core' . DIRECTORY_SEPARATOR . "Loader.php";
new \ModulesGarden\DomainsReseller\Registrar\TextraHostDomainReseller\Core\Loader(__DIR__);
 ...
 * @return array $return
 */
function TextraHostDomainReseller_getConfigArray()
{
    $configarray = [
        "FriendlyName" => [
            "Type"  => "System",
            "Value" => "TextraHost Domain Reseller"
        ],
        "Description"  => [
            "Type"  => "System",
            "Value" => "For any type of Help or Support kindly Contact Us : textrahost.in"
        ],
        "Username"     => [
        ...
        "ApiEndpoint"  => [
            ...
            "Default"      => "https://reseller.textrahost.in/modules/addons/DomainsReseller/api/index.php"
        ],
    ];
 ...
 * @return array $return
 */
function TextraHostDomainReseller_RegisterDomain($params)
{
    $postfields =
        [
 ...
 * @return array $return
 */
function TextraHostDomainReseller_TransferDomain($params)
{
    $postfields =
        [
            "domain"       => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_RenewDomain($params)
{
    $postfields =
        [
            "domain"    => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_GetNameservers($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function TextraHostDomainReseller_SaveNameservers($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_ReleaseDomain($params)
{
    $postfields =
        [
            "domain"      => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_GetEPPCode($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_GetContactDetails($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_SaveContactDetails($params)
{
    $postfields =
        [
            "domain"         => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_GetRegistrarLock($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_SaveRegistrarLock($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_GetDNS($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_SaveDNS($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_RegisterNameserver($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_ModifyNameserver($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_DeleteNameserver($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_RequestDelete($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function TextraHostDomainReseller_TransferSync($params)
{
    $postfields =
        [
 ...
 * @return array $return
 */
function TextraHostDomainReseller_Sync($params)
{
    $postfields =
        [
            "domain" => "{$params["sld"]}.{$params["tld"]}"
 ...
 * @return array $return
 */
function TextraHostDomainReseller_GetEmailForwarding($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function TextraHostDomainReseller_SaveEmailForwarding($params)
{
    $postfields =
        [
            "domain"    => $params["domainname"],
 ...
 * @return array $return
 */
function TextraHostDomainReseller_IDProtectionToggle($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array
 */
function TextraHostDomainReseller_IDProtectToggle($params)
{
    return TextraHostDomainReseller_IDProtectionToggle($params);
}
 ...
 */
function TextraHostDomainReseller_CheckAvailability($params)
{
    $postfields =
        [
